...
| [Audio/STUDY_GUIDE_AUDIO_FULL.txt](Audio/STUDY_GUIDE_AUDIO_FULL.txt) | **Active Reference** — generated 2026-09-02 from the same source as the study guide | The study guide written to be read aloud: no tables or paths, identifiers spoken, a pause cue before each quiz answer. About 31,700 words; `Audio/00_` to `18_` are the same text per module. |
