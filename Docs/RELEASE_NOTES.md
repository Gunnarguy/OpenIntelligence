> **Documentation status:** Source-verified and simulator-compiled for OpenIntelligence v4.6 on July 15, 2026. All 8 PCC routing tests and all 3 ingestion tombstone tests pass; the full suite is 109/110 due to an independent SemanticChunker named-entity expectation. Signed physical-device and distribution validation remains pending.
