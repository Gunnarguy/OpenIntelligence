...
- **Platforms:** iOS, macOS
- **Live:** 2026-09-24 on both platforms, build 478: iOS at 14:32 PT and macOS at 17:00 PT, each released through the App Store Connect API at the owner's request after approval, because the Release button in App Store Connect would not work for him (`Docs/SHIPPED_VERSION.json`). Records: iOS `edac9a46-fd9c-4082-99f8-372008d20289`, macOS `0e7e7d98-9878-4418-b977-3bc0b04ddf96`
- **Final release notes commit:** the 2026-09-23 commit after `3ad7ed6` that rewrote them for function and performance; revise if 5.4 gains more user-facing entries before it ships
