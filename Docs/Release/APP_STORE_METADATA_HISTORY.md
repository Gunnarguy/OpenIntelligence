...
- **Platforms:** iOS, macOS
- **Live:** iOS 2026-09-24, build 478, released through the App Store Connect API at the owner's request because the Release button in App Store Connect would not work for him; macOS in review with the same build (`Docs/SHIPPED_VERSION.json`). Records: iOS `edac9a46-fd9c-4082-99f8-372008d20289`, macOS `0e7e7d98-9878-4418-b977-3bc0b04ddf96`
