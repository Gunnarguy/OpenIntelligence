...
### Your Camera
- **Scan Document is back in the attachment menu, and the live view draws boxes around what it finds.** Point the camera and text, documents, people, faces and animals are outlined where they are, with a label. The screen has been in the app since v1, switched off.
