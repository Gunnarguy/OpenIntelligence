...
This folder keeps the source links and implementation mapping separate from the main docs. The intent is to keep pitch docs readable while preserving evidence for technical diligence.
...
- [Healthcare, EHR, and Medical-Device RAG](./HEALTHCARE_EHR_AND_MEDICAL_DEVICE_RAG.md): healthcare RAG, EHR summarization, medical-device document use cases, and claim boundaries.
