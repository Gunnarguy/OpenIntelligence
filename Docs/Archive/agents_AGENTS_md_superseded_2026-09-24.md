# `.agents/AGENTS.md`, superseded 2026-09-24

> **Superseded by the root `AGENTS.md` (2026-09-24).** Kept for history. This was an older copy
> of the root directive list that had drifted from it: its rule 15 still required reading the
> Transition Plan and the Atlas at the start of every conversation, which the root file had
> retired, and it lacked the iCloud build warning. Nothing loaded it. The text below is exactly
> as it stood at commit `d5cc916`.
