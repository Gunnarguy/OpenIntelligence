...
#ifndef OPENINTELLIGENCEENGINE_SWIFT_H
#define OPENINTELLIGENCEENGINE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OpenIntelligenceEngine",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("OpenIntelligenceEngine", usrValue)
...
namespace OpenIntelligenceEngine SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("OpenIntelligenceEngine") {


class FTS5PatternCount { } SWIFT_UNAVAILABLE_MSG("actor-isolated struct 'FTS5PatternCount' can not be exposed to C++");

class FTS5SearchResult { } SWIFT_UNAVAILABLE_MSG("actor-isolated struct 'FTS5SearchResult' can not be exposed to C++");

class OIAvailabilityState { } SWIFT_UNAVAILABLE_MSG("actor-isolated enum 'OIAvailabilityState' can not be exposed to C++");

class OICitation { } SWIFT_UNAVAILABLE_MSG("actor-isolated struct 'OICitation' can not be exposed to C++");

class OIEngine { } SWIFT_UNAVAILABLE_MSG("actor-isolated class 'OIEngine' can not be exposed to C++");

class OIEngineConfiguration { } SWIFT_UNAVAILABLE_MSG("actor-isolated struct 'OIEngineConfiguration' can not be exposed to C++");

class OIExecutionContext { } SWIFT_UNAVAILABLE_MSG("actor-isolated enum 'OIExecutionContext' can not be exposed to C++");

class OIIngestRequest { } SWIFT_UNAVAILABLE_MSG("actor-isolated struct 'OIIngestRequest' can not be exposed to C++");
...
class OpenIntelligenceEngineError { } SWIFT_UNAVAILABLE_MSG("Swift enum 'OpenIntelligenceEngineError' cannot be represented in C++");

} // namespace OpenIntelligenceEngine
