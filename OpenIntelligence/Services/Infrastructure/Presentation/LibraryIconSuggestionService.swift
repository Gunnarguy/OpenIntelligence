...
enum LibraryIconSuggestionService {
    ...
    enum ContentDomain: String, CaseIterable {
        ...
        var keywords: [String] {
            switch self {
            case .medical:
                return ["research", "study", "protocol", "cohort", "assay", "sample", "specimen",
                        "biology", "life science", "biomarker", "literature", "methods", "outcome",
                        "cell", "protein", "genome", "trial", "phase", "pharma", "compound"]
            case .legal:
            ...
            case .business:
                return ["business", "company", "corporation", "startup", "entrepreneur", "ceo", "manager",
                        ...
                        "revenue", "stakeholder", "client", "collaboration", "growth", "operations"]
            case .engineering:
