...
final class AdapterManager: ObservableObject {
    ...
    func availableAdapters() -> [AdapterDescriptor] {
        ...
        return [
            ...
            AdapterDescriptor(
                id: "life-sciences-v1",
                displayName: "Life Sciences Research",
                domain: .medical,
                version: "1.0.0",
                minimumOSVersion: "26.0",
                ...
                sha256: "",
                downloadURL: nil,
                description: "Specialized for research papers, terminology-heavy literature, and structured study notes. Improves entity and methods extraction.",
                trainedDate: Date(),
                keywords: ["study", "method", "trial", "cohort", "assay", "protocol", "outcome"]
            ),
            AdapterDescriptor(
                id: "legal-v1",
    ...
    private func keywordsForDomain(_ domain: AdapterDomain) -> [String] {
        ...
        case .medical:
            return ["study", "protocol", "cohort", "assay", "outcome", "literature", "methods", "abstract", "trial"]
        case .legal:
