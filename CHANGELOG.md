...
## 4.6 - 2026-07-14
### Fixed
- **[Orchestration]** The Silicon HUD legend is now draggable: put it anywhere on screen and the position persists across launches; double-tap the legend to reset it to its default spot right of the sidebar toggle.
