...
def main(client, customer_id):
    ...
    headline_assets = [
        upload_text_asset(client, customer_id, "OpenIntelligence iOS"),
        upload_text_asset(client, customer_id, "The Best AI Assistant"),
        upload_text_asset(client, customer_id, "Download on App Store"),
        upload_text_asset(client, customer_id, "Your Personal AI"),
        upload_text_asset(client, customer_id, "AI Powered Intelligence")
    ]
    long_headline_asset = upload_text_asset(client, customer_id, "Download OpenIntelligence today and unleash AI on your iPhone.")
    desc_assets = [
        upload_text_asset(client, customer_id, "The ultimate mobile AI assistant."),
        upload_text_asset(client, customer_id, "Experience the next generation of AI right on your iPhone."),
        upload_text_asset(client, customer_id, "OpenIntelligence helps you answer anything instantly.")
    ]
