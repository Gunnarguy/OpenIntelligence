...
- Ongoing reliability work around abstention, citation mapping, and source-faithful behavior
...
- Better trust when the app does answer
- Cleaner failure modes when the document set is not strong enough
- Less friction around import and longer document sessions
- A product surface that keeps moving toward inspectable, grounded document work instead of generic AI chat

## Earlier Milestones

- App Store launch on iPhone and iPad
