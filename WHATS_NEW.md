...
### Your Camera
- **Scan Document returns to the attachment menu, and the live view draws boxes around what it finds.** Text, documents, people, faces and animals are outlined where they are, with a label. The screen has been in the app since v1, switched off.
